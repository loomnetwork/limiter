...
```bash
$ go get github.com/loomnetwork/limiter
```
...
* Create a `limiter.Store` instance _(see [Redis](https://github.com/loomnetwork/limiter/blob/master/drivers/store/redis/store.go) or [In-Memory](https://github.com/loomnetwork/limiter/blob/master/drivers/store/memory/store.go))_
...
// race condition.
import "github.com/loomnetwork/limiter/drivers/store/redis"
...
import "github.com/loomnetwork/limiter/drivers/store/memory"
...
* [HTTP](https://github.com/loomnetwork/limiter/tree/master/examples/http/main.go)
* [Gin](https://github.com/loomnetwork/limiter/tree/master/examples/gin/main.go)
...
* Fork the [project](https://github.com/loomnetwork/limiter)
* Fix [bugs](https://github.com/loomnetwork/limiter/issues)
...
[godoc-url]: https://godoc.org/github.com/loomnetwork/limiter
[godoc-img]: https://godoc.org/github.com/loomnetwork/limiter?status.svg
[license-img]: https://img.shields.io/badge/license-MIT-blue.svg
[goreport-url]: https://goreportcard.com/report/github.com/loomnetwork/limiter
[goreport-img]: https://goreportcard.com/badge/github.com/loomnetwork/limiter
